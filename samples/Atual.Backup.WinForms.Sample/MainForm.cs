...
public sealed class MainForm : Form
{
    ...
    {
        Text = "Atual Backup Engine — ERP Integration Sample";
    ...
    private void BuildBackupTab()
    {
        ...
        {
            Text = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "AtualBackupSample", "Repository"),
            Location = new Point(15, 45),
        ...
        var sampleSourceDir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "AtualBackupSample", "ERP");
    ...
    private void BuildCatalogTab()
    {
        ...
        {
            Text = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "AtualBackupSample", "Restored"),
